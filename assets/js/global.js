...
function infos() {
  ...
  console.log("%c[Launcher]" + "%c [Infos]" + "%c Informations sur le Launcher et l'appareil :\n\n" +
    ...
    " Ce Launcher est basé sur GoldFrite Launcher de GoldFrite. Il utilise minecraft-launcher-core et minecraft-server-util, fontawesome-free, nodejs-file-downloader, decompress, axios et electron.", 
